...
\item Complete implementations of all four tasks, with $134$ unit
...
Cross-attention & 66.8M & 0.192 & 0.324 & 0.176 \\
\midrule
...
$\mathbf{0.246}$, Micro-F1 from $0.324$ to $\mathbf{0.415}$ and AUC-PR from
$0.176$ to $\mathbf{0.248}$. The same run's attention entropy falls from
