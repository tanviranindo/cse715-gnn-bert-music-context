...
\item Complete implementations of all four tasks, with $107$ unit
...
built (\texttt{src/human\_eval.py} generates the rating sheet and aggregates
returned ratings, refusing to score fewer than five raters), but the study
itself needs listeners we did not have, and it remains a gap against the brief
rather than a considered omission.
